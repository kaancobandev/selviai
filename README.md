...
| `/hizmetler/shooting` | **Çekim listesi** — tasarlanan giysiden üretilecek kareler: satır başına kadraj + ışık senaryosu, hepsi tek işte (prodüksiyon masası kaldırıldı — bkz. DESIGN.md H) |
